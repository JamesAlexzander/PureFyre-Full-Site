...
$(function() {
    ...
    // 15.2. news carousel
    $("#distillate-carousel").owlCarousel({
        loop: true,
        center: true,
        items: 6,
        margin: 0,
	...
	// 16. direct news modal linking
    if (window.location.href.indexOf('#flowerModal-1') != -1) {
	    $('#flowerModal-1').modal('show');
	}
	if (window.location.href.indexOf('#flowerModal-2') != -1) {
	    $('#flowerModal-2').modal('show');
	}
	if (window.location.href.indexOf('#flowerModal-3') != -1) {
	    $('#flowerModal-3').modal('show');
	}
	if (window.location.href.indexOf('#flowerModal-4') != -1) {
	    $('#flowerModal-4').modal('show');
	}
	if (window.location.href.indexOf('#flowerModal-5') != -1) {
	    $('#flowerModal-5').modal('show');
	}
